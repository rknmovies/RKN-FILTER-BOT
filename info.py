...
PICS = (environ.get('PICS', 'https://envs.sh/r8h.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7342623120 1981280736').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002303163400').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002303163400') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request File With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002137202501')
...
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', -1002402253939))
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://raajkiccha97:rknmovies1@rknmovies.d1vah.mongodb.net/?retryWrites=true&w=majority&appName=rknmovies")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "rknmovies1")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'rknfiles')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/RKNBigloots')
